...
function play1(){
	load_data($("#data1").val()+"dtid2=7&opt=1",1)
}
$(document).ready(function() {
	
	var url1="dtid2=7&opt=";
...
<div class="wrapper">
    ...
    <div class="container">
        ...
        <div class="sidebar">
            <dl class="side-nav">
                ...
                <dd>
                    ...
                    <li class="selected"><cite></cite><a href="meltponds">Melt Ponds</a></li>
		...
		<div class="cl"></div>
		<div class="mt20">The summertime 8-days Arctic melt ponds is produced by Beijing Normal University PRSDC team. It is derived from Moderate Resolution Imaging Spectroradiometer (MODIS) band 1, 3 and 4 reflectance data using a combination of spectral unmixing method and artificial neural network. Here we provide melt ponds in 6.25 km Polar Stereographic and EASE-Grid2.0 projection.
		</div>
