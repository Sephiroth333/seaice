...
<body>
    ...
    <script type="text/javascript">
	    ...
	    function checkupdate(dataid,checkstatus){
	    	$.ajax({
				type:"get",
				url:"dataCheck?id="+dataid+"&checkstatus="+checkstatus+"&fid="+$("#dtfatherid").val(),
				dataType:"json",
	    ...
	    function delupdate(dataid){
	    	$.ajax({
				type:"get",
				url:"dataDel?id="+dataid+"&fid="+$("#dtfatherid").val(),
				dataType:"json",
				success: function(data){
