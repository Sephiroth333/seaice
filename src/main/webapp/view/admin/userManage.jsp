...
<body>
    ...
    <table class="tablelist">
        ...
        <tr>
        	...
        	<td>${item.getLoginemail() }</td>
        	<td>${item.getCompany() }</td>
        	<td>${item.getUserstatus()==2?"管理员禁用":item.getUserstatus()==1?"验证通过":"待验证邮箱" }</td>
        	<td><a onclick="javascript:modify(${item.getUserid()})" href="#" class="modify">管理</a>
        		<a onclick="javascript:del(${item.getUserid()})" href="#" class="tablelink removeBtn">删除</a>
        		<a onclick="javascript:reset(${item.getUserid()})" href="#" class="reset">重置</a>
        	</td>
        </tr>
        </c:forEach>
        </tbody>
    ...
    <form id="modify_form">
      ...
      <div class="tipinfo">
        <div class="tipright">
            ...
            <div class="group">
                <label>真实姓名：</label>
                <input id="realname" name="realname2" type="text" class="dfinput" placeholder="请输入姓名" />
            </div>
            <div class="group">
                <label>单位：</label>
                <input id="company" name="company2" type="text" class="dfinput" placeholder="请输入单位" />
            </div>
            <div class="group">
                <label>账号状态：</label>
    ...
    <form id="add_form">
      ...
      <div class="tipinfo">
        <div class="tipright">
            ...
            <div class="group">
                <label>真实姓名：</label>
                <input id="realname" name="realname" type="text" class="dfinput" placeholder="请输入姓名" />
            </div>
            <div class="group">
                <label>单位：</label>
                <input id="company" name="company" type="text" class="dfinput" placeholder="请输入单位" />
            </div>
        </div>
        </div>
        <div class="tipbtn">
    ...
    function pagejump(nowpage){
    	window.location.href="userManage?&pageNow="+nowpage;
    }
    function pagejump2(){
