...
;(function(root, factory) {
	...
	*/
    ...
    jeDt.setHtml = function(opts, self, lyerCell) {
        ...
        var dateymList = !isYYMM ? '<div class="jedatetopym" style="display: none;">' + '<ul class="ymdropul"></ul><p><span class="jedateymchle">&#8592;</span><span class="jedateymchri">&#8594;</span><span class="jedateymchok">Close</span></p>' + "</div>" :'<ul class="jedaym"></ul>';
        var dateriList = '<ol class="jedaol"></ol><ul class="jedaul"></ul>';
        var bothmsStr = !isYYMM ? '<div class="botflex jedatehmsshde"><ul class="jedatehms"><li><em></em><i>:</i></li><li><em></em><i>:</i></li><li><em></em></li></ul></div>' + '<div class="botflex jedatebtn"><span class="jedateok">Confirm</span><span class="jedateclear">Clear</span></div>' :'<div class="botflex jedatebtn"><span class="jedateok">Confirm</span><span class="jedatetodaymonth">This Month</span><span class="jedateclear">Clear</span></div>';        
